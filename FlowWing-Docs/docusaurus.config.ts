...
const config: Config = {
  title: "Flow-Wing",
  tagline: "An Experimental Programming Language",
  ...
  plugins: [
    ...
    [
      ...
      {
        redirects: [
          // Directory renames — redirect old paths to new
          ...
          { from: '/docs/Creating%20an%20Server/Creating%20an%20Server', to: '/docs/Creating%20a%20Server/' },
          ...
          { from: '/docs/Language%20Fundamentals/Custom%20Type%20and%20Objects/Custom%20Types', to: '/docs/Language%20Fundamentals/Custom%20Types%20and%20Objects/' },
          { from: '/docs/Language%20Fundamentals/Custom%20Type%20and%20Objects/Objects', to: '/docs/Language%20Fundamentals/Custom%20Types%20and%20Objects/' },
