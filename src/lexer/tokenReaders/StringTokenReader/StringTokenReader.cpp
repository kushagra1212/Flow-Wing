...
StringTokenReader::readToken(Lexer &lexer) {
...
std::unique_ptr<SyntaxToken<std::any>>
StringTokenReader::unTerminatedStringToken(Lexer &lexer, const size_t &start) {
...
std::unique_ptr<SyntaxToken<std::any>>
StringTokenReader::badEscapeSequenceToken(Lexer &lexer, const size_t &start) {
