...
CharacterTokenReader::readToken(Lexer &lexer) {
...
std::unique_ptr<SyntaxToken<std::any>>
CharacterTokenReader::unTerminatedCharacterToken(Lexer &lexer,
                                                 const size_t &start) {
...
std::unique_ptr<SyntaxToken<std::any>>
CharacterTokenReader::badEscapeSequenceToken(Lexer &lexer,
                                             const size_t &start) {
