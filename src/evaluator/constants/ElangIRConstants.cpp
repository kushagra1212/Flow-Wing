...
const std::string ELANG_GLOBAL_RETURN_COUNT = "ELANG_GLOBAL_RETURN_COUNT";

// For Error

const std::string ELANG_GLOBAL_ERROR_COUNT = "ELANG_GLOBAL_ERROR_COUNT";
...
// Entry Point
const std::string ELANG_GLOBAL_ENTRY_POINT = "main";
