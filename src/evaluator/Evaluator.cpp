...
//   this->root->logs.push_back("Error: Variable '" + name + "' is not
//   declared"); return Utils::Variable();
// }
...
//   this->root->logs.push_back("Error: Function '" + name + "' is not
//   declared"); return nullptr;
// }
...
//   BoundVariableExpression *variableExpression = (BoundVariableExpression
//   *)node;
...
//   std::any left_any =
//   (this->evaluate<std::any>(binaryExpression->getLeft())); std::any right_any
...
//     return binaryExpressionEvaluatorDoubleDoubleHandler<double, double,
//     double>(
...
//   }
//   // stringbool
//   else if (left.type() == typeid(std::string) && right.type() ==
//   typeid(bool)) {
...
//   }
//   // boolstring
//   else if (left.type() == typeid(bool) && right.type() ==
//   typeid(std::string)) {
...
//   case BinderKindUtils::BoundBinaryOperatorKind::GreaterOrEquals:
//     throw std::runtime_error("Error: Greater or equals not supported for
//     bool");
//   case BinderKindUtils::BoundBinaryOperatorKind::BitwiseAnd:
//     return left & right;
//   case BinderKindUtils::BoundBinaryOperatorKind::BitwiseOr:
...
//   case BinderKindUtils::BoundBinaryOperatorKind::Multiplication:
//     throw std::runtime_error("Error: Multiplication not supported for
//     string");
//   case BinderKindUtils::BoundBinaryOperatorKind::Division:
...
//   case BinderKindUtils::BoundBinaryOperatorKind::LessOrEquals:
//     throw std::runtime_error("Error: Less or equals not supported for
//     string");
//   case BinderKindUtils::BoundBinaryOperatorKind::Greater:
