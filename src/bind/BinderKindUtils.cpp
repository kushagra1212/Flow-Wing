...
BinderKindUtils::BoundUnaryOperatorKind BinderKindUtils::getUnaryOperatorKind(
...
BinderKindUtils::BoundBinaryOperatorKind BinderKindUtils::getBinaryOperatorKind(
    SyntaxKindUtils::SyntaxKind kind) {
  switch (kind) {
    case SyntaxKindUtils::SyntaxKind::PlusToken:
