...
class DimensionClauseExpressionSyntax : public ExpressionSyntax {

public:
  DimensionClauseExpressionSyntax(
...
private:
  ...
  std::unique_ptr<ExpressionSyntax> m_size_literal;
  const SyntaxToken *m_close_bracket;
