...
ASTBuilder::ASTBuilder(
  ...
  lexer = std::make_unique<SourceTokenizer>(sourceCode, diagnosticHandler);
...
SyntaxToken<std::any> *ASTBuilder::peek(const int &offset) {
...
SyntaxToken<std::any> *ASTBuilder::getCurrent() { return this->peek(0); }

std::unique_ptr<SyntaxToken<std::any>> ASTBuilder::nextToken() {
...
SyntaxKindUtils::SyntaxKind ASTBuilder::getKind() {
...
ASTBuilder::match(const SyntaxKindUtils::SyntaxKind &kind) {
...
bool ASTBuilder::matchKind(const SyntaxKindUtils::SyntaxKind &kind) {
  return this->getKind() == kind;
}
std::unique_ptr<CompilationUnitSyntax> ASTBuilder::parseCompilationUnit() {
  this->position = 0;
...
std::unique_ptr<MemberSyntax> ASTBuilder::parseMember() {
  ...
  if (currentKind == SyntaxKindUtils::SyntaxKind::FunctionKeyword) {
    ...
    auto functionDeclaration = std::move(this->parseFunctionDeclaration());
...
std::unique_ptr<SyntaxToken<std::any>> ASTBuilder::parsePrimitiveType() {
  switch (this->getKind()) {
...
ASTBuilder::parseFunctionDeclaration() {
...
std::unique_ptr<ArrayTypeExpressionSyntax>
ASTBuilder::parseArrayTypeExpression() {
...
std::unique_ptr<TypeExpressionSyntax> ASTBuilder::parseTypeExpression() {
...
ASTBuilder::parseFunctionTypeExpression() {
...
ASTBuilder::parseObjectTypeExpression() {
...
std::unique_ptr<GlobalStatementSyntax> ASTBuilder::parseGlobalStatement() {
...
std::unique_ptr<BlockStatementSyntax> ASTBuilder::parseBlockStatement() {
...
std::unique_ptr<ExpressionStatementSyntax>
ASTBuilder::parseExpressionStatement() {
  std::unique_ptr<ExpressionSyntax> expression =
      std::move(this->parseExpression());
  return std::make_unique<ExpressionStatementSyntax>(std::move(expression));
}

std::unique_ptr<StatementSyntax> ASTBuilder::parseStatement() {
...
std::unique_ptr<CaseStatementSyntax> ASTBuilder::parseCaseStatement() {
...
std::unique_ptr<StatementSyntax> ASTBuilder::parseSwitchStatement() {
...
std::unique_ptr<StatementSyntax> ASTBuilder::parseModuleStatement() {
...
std::unique_ptr<ClassStatementSyntax> ASTBuilder::parseClassStatement() {
...
std::unique_ptr<ExpressionSyntax> ASTBuilder::parseBracketedExpression() {
...
ASTBuilder::parseCustomTypeStatement() {
...
std::unique_ptr<ContainerExpressionSyntax>
ASTBuilder::parseContainerExpression() {
...
std::unique_ptr<StatementSyntax> ASTBuilder::parseBringStatement() {
...
std::unique_ptr<ReturnStatementSyntax> ASTBuilder::parseReturnStatement() {
...
std::unique_ptr<BreakStatementSyntax> ASTBuilder::parseBreakStatement() {
...
std::unique_ptr<ContinueStatementSyntax> ASTBuilder::parseContinueStatement() {
...
std::unique_ptr<ForStatementSyntax> ASTBuilder::parseForStatement() {
...
std::unique_ptr<ElseClauseSyntax> ASTBuilder::parseElseStatement() {
...
std::unique_ptr<IfStatementSyntax> ASTBuilder::parseIfStatement() {
...
std::unique_ptr<WhileStatementSyntax> ASTBuilder::parseWhileStatement() {
  std::unique_ptr<SyntaxToken<std::any>> keyword =
...
ASTBuilder::parseMultipleVariableDeclaration(
...
std::unique_ptr<StatementSyntax> ASTBuilder::parseVariableDeclaration() {
  std::unique_ptr<VariableDeclarationSyntax> varDec =
      std::make_unique<VariableDeclarationSyntax>();

  handleVarDecParsePrefixKeywords(varDec, false);
...
ASTBuilder::parseSingleVariableDeclaration(bool isFuncDec) {
  std::unique_ptr<VariableDeclarationSyntax> varDec =
      std::make_unique<VariableDeclarationSyntax>();
...
void ASTBuilder::handleVarDecParsePrefixKeywords(
...
void ASTBuilder::handleVarDecParseInitializer(
    std::unique_ptr<VariableDeclarationSyntax> &varDec) {
  if (this->getKind() == SyntaxKindUtils::SyntaxKind::EqualsToken) {
    appendWithSpace();
    std::unique_ptr<SyntaxToken<std::any>> equalsToken =
...
void ASTBuilder::handleVarDecParseIdentifierAndType(
    std::unique_ptr<VariableDeclarationSyntax> &varDec) {
  std::unique_ptr<SyntaxToken<std::any>> identifier =
      std::move(this->match(SyntaxKindUtils::SyntaxKind::IdentifierToken));
...
ASTBuilder::parseExpression(int parentPrecedence) {
  ...
  if (this->getKind() == SyntaxKindUtils::SyntaxKind::QuestionToken) {
    auto ternaryExpression = std::move(this->parseTernaryExpression());
...
std::unique_ptr<FillExpressionSyntax> ASTBuilder::parseFillExpression() {
...
ASTBuilder::makeLiteralExpression(const SyntaxKindUtils::SyntaxKind kind) {
...
std::unique_ptr<ExpressionSyntax> ASTBuilder::parsePrimaryExpression() {
...
std::unique_ptr<StatementSyntax> ASTBuilder::parseCommentStatement() {
...
std::unique_ptr<ObjectExpressionSyntax> ASTBuilder::parseObjectExpression() {
...
std::unique_ptr<ExpressionSyntax>
ASTBuilder::parseModuleIdentifierExpression() {
  ...
  std::unique_ptr<ExpressionSyntax> member =
      std::move(this->parseNameorCallExpression());
  std::unique_ptr<TypeExpressionSyntax> typeExpression =
      std::make_unique<TypeExpressionSyntax>(
          std::make_unique<SyntaxToken<std::any>>(
              this->_diagnosticHandler->getAbsoluteFilePath(), 0,
...
std::unique_ptr<ExpressionSyntax> ASTBuilder::parseVariableExpression() {
  ...
  if (identifierToken->getValue().type() == typeid(std::string) &&
    ...
    if (this->getKind() == SyntaxKindUtils::SyntaxKind::DotToken) {
      ...
      auto expression = std::move(this->parseNameorCallExpression());
...
std::unique_ptr<ExpressionSyntax> ASTBuilder::parseIndexExpression() {
  std::unique_ptr<SyntaxToken<std::any>> identifierToken =
      std::move(this->match(SyntaxKindUtils::SyntaxKind::IdentifierToken));
...
std::unique_ptr<ExpressionSyntax>
ASTBuilder::parseMultipleAssignmentExpression() {
  ...
  do {
    ...
    std::unique_ptr<VariableExpressionSyntax> variableExpression(
        static_cast<VariableExpressionSyntax *>(
            this->parseVariableExpression().release()));
...
std::unique_ptr<ExpressionSyntax> ASTBuilder::parseNameorCallExpression() {
  if (this->peek(1)->getKind() == SyntaxKindUtils::SyntaxKind::EqualsToken ||
    ...
    return std::move(this->parseMultipleAssignmentExpression());
  } else {
    return std::move(parseVariableExpression());
  }
}

std::unique_ptr<ExpressionSyntax> ASTBuilder::parseTernaryExpression() {
...
std::unique_ptr<ExpressionSyntax> ASTBuilder::parseCallExpression() {
