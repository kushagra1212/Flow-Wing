...
class ModuleAccessExpressionParser : public ExpressionParser {

public:
  explicit ModuleAccessExpressionParser(ParserContext *ctx);

  std::unique_ptr<syntax::ExpressionSyntax> parse() override;

  std::unique_ptr<syntax::ExpressionSyntax> parsePostfix(
