...
std::unique_ptr<BoundExpression> ExpressionBinder::bindParenthesizedExpression(
  ...
  return std::make_unique<BoundParenthesizedExpression>(
      std::move(expression), node->getSourceLocation());
