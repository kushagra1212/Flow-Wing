...
#include "BoundNewExpression.hpp"
...
void BoundNewExpression::accept(visitor::BoundTreeVisitor *visitor) {
  visitor->visit(this);
}

std::shared_ptr<types::Type> BoundNewExpression::getType() const {
