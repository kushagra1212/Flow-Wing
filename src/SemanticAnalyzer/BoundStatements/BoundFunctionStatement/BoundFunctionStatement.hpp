...
class BoundFunctionStatement : public BoundDeclarationStatement {

public:
  BoundFunctionStatement(std::vector<std::shared_ptr<analysis::Symbol>> symbols,
                         const flow_wing::diagnostic::SourceLocation &location);
  ~BoundFunctionStatement() = default;
