...
print(arr)
  ...
  EXPECT_EQ(
      getOutput(),
      "[{ x : 1, y : '', a : 0.00000000000000, b : false, arr : [{ u : '', g : "
...
print(arr))");
  EXPECT_EQ(getOutput(), "[{ x : 2, y : 'hello', a : 3.30000000000000, b : "
                         "true, arr : [{ u : '', g "
                         ": [{ o : 0 }, { o : 0 }, { o : 0 }, { o : 0 }, { o : "
                         "0 }] }] }, { x : 0, "
                         "y : '', a : 0.00000000000000, b : false, arr : [{ u "
                         ": '', g : [{ o : 0 }, "
                         "{ o : 0 }, { o : 0 }, { o : 0 }, { o : 0 }] }] }]");
}
...
print(arr))");
  EXPECT_EQ(
      getOutput(),
      "[{ x : 2, y : 'hello', a : 3.30000000000000, b : true, arr : [{ u : "
...
print(arr))");
  EXPECT_EQ(
      ...
      ": "
      "'', d : 0.00000000000000, i : 0 }, { o : 0, s : '', d : "
      "0.00000000000000, "
...
print(arr)
  ...
  EXPECT_EQ(
      ...
      "g "
      ": [{ o : 0, s : '', d : 0.00000000000000, i : 0 }, { o : 0, s : '', d : "
      "0.00000000000000, i : 0 }] }] }, { x : 0, y : '', a : 0.00000000000000, "
      "b "
...
print(x)
  ...
  EXPECT_EQ(
      getOutput(),
      "[0, 0][0.00000000000000, 0.00000000000000]['', ''][false, false]{ x : "
      "2, "
...
print(x)
  ...
  EXPECT_EQ(
      getOutput(),
      "[5, 5][2.20000000000000, 0.00000000000000]['hello', ''][true, true]{ x "
      ": "
...
print(arr[1]) 
  ...
  EXPECT_EQ(
      getOutput(),
      "2hello3.30000000000000true[{ u : 'arru', g : [{ o : 102, s : 'sora', d "
      ": "
      "0.00000000000000, i : 0 }, { o : 0, s : '', d : 0.00000000000000, i : 0 "
      "}] }]{ x : 0, y : '', a : 0.00000000000000, b : false, arr : [{ u : '', "
      "g "
      ": [{ o : 0, s : '', d : 0.00000000000000, i : 0 }, { o : 0, s : '', d : "
...
print(arr[0].ar[0].g[0].o)
  ...
  EXPECT_EQ(
      getOutput(),
      R"([{ x : 2, y : 'hello', a : 3.30000000000000, b : true, ar : [{ u : 'arru', g : [{ o : 102, s : 'sora', d : 0.00000000000000, i : 0 }, { o : 0, s : '', d : 0.00000000000000, i : 0 }] }] }, { x : 0, y : '', a : 0.00000000000000, b : false, ar : [{ u : '', g : [{ o : 0, s : '', d : 0.00000000000000, i : 0 }, { o : 0, s : '', d : 0.00000000000000, i : 0 }] }] }]
...
print(arr2[0].ar[0].g[0].d)
  ...
  EXPECT_EQ(
      getOutput(),
      R"([{ x : 2, y : 'hello', a : 3.30000000000000, b : true, ar : [{ u : 'get', g : [{ o : 102, s : 'sora', d : 0.00000000000000, i : 0 }, { o : 0, s : '', d : 0.00000000000000, i : 0 }] }] }, { x : 0, y : '', a : 0.00000000000000, b : false, ar : [{ u : '', g : [{ o : 0, s : '', d : 0.00000000000000, i : 0 }, { o : 0, s : '', d : 0.00000000000000, i : 0 }] }] }]
0.00000000000000)");
}
...
print(arr2[0].ar[0].g[0].d)
  ...
  EXPECT_EQ(
      getOutput(),
      R"([{ x : 0, y : 'j', a : 2.20000000000000, b : false, ar : [{ u : '', g : [{ o : 0, s : '', d : 0.00000000000000, i : 0 }, { o : 0, s : '', d : 0.00000000000000, i : 0 }] }] }, { x : 0, y : '', a : 0.00000000000000, b : false, ar : [{ u : '', g : [{ o : 0, s : '', d : 0.00000000000000, i : 0 }, { o : 0, s : '', d : 0.00000000000000, i : 0 }] }] }]
0.00000000000000)");
}
...
print(arr)
  ...
  EXPECT_EQ(
      getOutput(),
      R"([{ x : 2, y : 'hello', a : 3.30000000000000, b : true, ar : [{ u : 'get', g : [{ o : 102, s : 'sora', d : 0.00000000000000, i : 1022 }, { o : 0, s : '', d : 0.00000000000000, i : 0 }] }] }, { x : 0, y : '', a : 0.00000000000000, b : false, ar : [{ u : '', g : [{ o : 0, s : '', d : 0.00000000000000, i : 0 }, { o : 0, s : '', d : 0.00000000000000, i : 0 }] }] }]
...
print(sec)
  ...
  EXPECT_EQ(
      getOutput(),
      R"([{ x : 0, y : '', a : 3.50000000000000, b : false, ar : [{ u : '', g : [{ o : 0, s : 'god', d : 0.00000000000000, i : 12 }, { o : 0, s : '', d : 0.00000000000000, i : 0 }] }] }, { x : 0, y : '', a : 0.00000000000000, b : false, ar : [{ u : '', g : [{ o : 0, s : '', d : 0.00000000000000, i : 0 }, { o : 0, s : '', d : 0.00000000000000, i : 0 }] }] }, { x : 0, y : '', a : 0.00000000000000, b : false, ar : [{ u : '', g : [{ o : 0, s : '', d : 0.00000000000000, i : 0 }, { o : 0, s : '', d : 0.00000000000000, i : 0 }] }] }])");
}
...
print(arr)
  ...
  EXPECT_EQ(
      getOutput(),
      R"([{ x : 2, y : 'hello', a : 3.30000000000000, b : true, ar : [{ u : 'get', g : [{ o : 102, s : 'sora', d : 0.00000000000000, i : 1022, ob : { i : 0, s : '' } }, { o : 0, s : '', d : 0.00000000000000, i : 0, ob : { i : 0, s : '' } }] }] }, { x : 0, y : '', a : 0.00000000000000, b : false, ar : [{ u : '', g : [{ o : 0, s : '', d : 0.00000000000000, i : 0, ob : { i : 0, s : '' } }, { o : 0, s : '', d : 0.00000000000000, i : 0, ob : { i : 0, s : '' } }] }] }]
...
print(r.g[1])
  ...
  EXPECT_EQ(
      getOutput(),
      "{ o : 0, s : '', d : 0.00000000000000, i : 0, ob : { i : 0, s : '' } }");
}
...
print(r.g[0].ob)
  ...
  EXPECT_EQ(getOutput(), R"(00Hello2.30000000000000{ i : 0, s : 'g' }
...
def()
  ...
  EXPECT_EQ(
      getOutput(),
      R"(print a in block { s : '' }print a gloabl{ a : 0 }print y { a : 0, j : '' })");
}
...
print(x)
  ...
  EXPECT_EQ(getOutput(), R"(aa10{ a : 111 }aa2{ a : 111 })");
}
...
print(x)
  ...
  EXPECT_EQ(getOutput(), R"(aa10{ a : 10 }aa2{ a : 2 })");
}
...
print(x)
  ...
  EXPECT_EQ(
      getOutput(),
      R"(aa10[{ b : [{ s : '', d : 0.00000000000000 }, { s : '', d : 0.00000000000000 }], a : 10 }, { b : [{ s : '', d : 0.00000000000000 }, { s : '', d : 0.00000000000000 }], a : 0 }, { b : [{ s : '', d : 0.00000000000000 }, { s : '', d : 0.00000000000000 }], a : 0 }, { b : [{ s : '', d : 0.00000000000000 }, { s : '', d : 0.00000000000000 }], a : 0 }, { b : [{ s : '', d : 0.00000000000000 }, { s : '', d : 0.00000000000000 }], a : 0 }]aa2[{ b : [{ s : '', d : 0.00000000000000 }, { s : '', d : 0.00000000000000 }], a : 2 }, { b : [{ s : '', d : 0.00000000000000 }, { s : '', d : 0.00000000000000 }], a : 0 }, { b : [{ s : '', d : 0.00000000000000 }, { s : '', d : 0.00000000000000 }], a : 0 }, { b : [{ s : '', d : 0.00000000000000 }, { s : '', d : 0.00000000000000 }], a : 0 }, { b : [{ s : '', d : 0.00000000000000 }, { s : '', d : 0.00000000000000 }], a : 0 }])");
}
...
print(x.a)
  ...
  EXPECT_EQ(
      getOutput(),
      R"(aa10{ b : [{ s : 'nice', d : 2.20000000000000 }, { s : '', d : 0.00000000000000 }], a : 10 }aa2{ b : [{ s : 'nice', d : 2.20000000000000 }, { s : '', d : 0.00000000000000 }], a : 2 })");
}
...
print(ar)
  ...
  EXPECT_EQ(getOutput(), R"(2.2000000)");
}
...
print(ar)
  ...
  EXPECT_EQ(getOutput(), R"(32.2220001)");
}
...
print(arr)
  ...
  EXPECT_EQ(getOutput(), R"([2.2000000, 0.0000000])");
}
...
print(arr)
  ...
  EXPECT_EQ(getOutput(), R"([2.2000000, 2.2000000])");
}
...
fun printdec(a:deci32[2]) -> nthg {
 ...
 printdec([3.2d])
  ...
  EXPECT_EQ(getOutput(), R"([3.2000000, 0.0000000])");
}
...
print(x)
  ...
  EXPECT_EQ(getOutput(), R"({ a : [2.2000000, 2.2000000] })");
}
#endif