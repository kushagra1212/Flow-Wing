; ModuleID = '/aot-compiler-dev/all-targets/aot-compiler/aot-compiler-build/lib/FlowWing/built_in_module.bc'
...
@1 = private unnamed_addr constant [13 x i8] c"Hello World\0A\00", align 1
@2 = private unnamed_addr constant [13 x i8] c"Hello World\0A\00", align 1
@3 = private unnamed_addr constant [13 x i8] c"Hello World\0A\00", align 1
@4 = private unnamed_addr constant [13 x i8] c"Hello World\0A\00", align 1
@5 = private unnamed_addr constant [13 x i8] c"Hello World\0A\00", align 1
...
@6 = private unnamed_addr constant [13 x i8] c"Hello World\0A\00", align 1
...
define ptr @concat_strings(ptr %str1, ptr %str2) {
  ...
  %concatStr = call ptr @malloc(i32 %totalLen)
