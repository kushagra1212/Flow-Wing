...
1. **Install** the compiler and (separately) a **raylib** build for your OS—see **[Getting Started → Installation](../Getting%20Started/Installation.md)** and your platform’s **raylib** install guide.
