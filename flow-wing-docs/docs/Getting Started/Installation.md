...
Release assets are named with the **version tag** (for example **`FlowWing-v1.0.3-macos-arm64.pkg`**)—pick the same tag on the [releases](https://github.com/kushagra1212/Flow-Wing/releases) page for every file you download.
