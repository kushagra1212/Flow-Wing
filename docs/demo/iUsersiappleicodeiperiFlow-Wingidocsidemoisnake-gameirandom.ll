; ModuleID = 'iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameirandom'
source_filename = "iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameirandom"

@iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameirandom_FLOWWING_GLOBAL_TRUE = constant [5 x i8] c"true\00"
@iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameirandom_FLOWWING_GLOBAL_FALSE = constant [6 x i8] c"false\00"
@iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameirandom_FLOWWING_GLOBAL_NULL = external global i8
@iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameirandom_FLOWWING_BREAK_COUNT = global i32 0
@iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameirandom_FLOWWING_CONTINUE_COUNT = global i32 0
@iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameirandom_FLOWWING_GLOBAL_ERROR_COUNT = global i32 0
...
define i32 @iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameirandom() {
entry:
...
mergeBlock:                                       ; No predecessors!
  %13 = load i32, ptr @iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameirandom_FLOWWING_BREAK_COUNT, align 4
  %14 = icmp eq i32 %13, 0
