...
checkContinueBlock:                               ; preds = %nestedBlock
  %21 = load i32, ptr @iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameiFlowWingAnim_FLOWWING_CONTINUE_COUNT, align 4
  %22 = icmp eq i32 %21, 0
...
checkContinueBlock4:                              ; preds = %nestedBlock3
  %32 = load i32, ptr @iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameiFlowWingAnim_FLOWWING_CONTINUE_COUNT, align 4
  %33 = icmp eq i32 %32, 0
...
checkContinueBlock8:                              ; preds = %nestedBlock7
  %46 = load i32, ptr @iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameiFlowWingAnim_FLOWWING_CONTINUE_COUNT, align 4
  %47 = icmp eq i32 %46, 0
...
nestedBlock9:                                     ; preds = %checkContinueBlock8
  ...
  %51 = load i32, ptr @iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameiFlowWingAnim_FLOWWING_BREAK_COUNT, align 4
  %52 = icmp eq i32 %51, 0
...
nestedBlock:                                      ; preds = %entry
  ...
  %34 = load i32, ptr @iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameiFlowWingAnim_FLOWWING_BREAK_COUNT, align 4
  %35 = icmp eq i32 %34, 0
  br i1 %35, label %checkContinueBlock, label %afterNestedBlock

checkContinueBlock:                               ; preds = %nestedBlock
  %36 = load i32, ptr @iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameiFlowWingAnim_FLOWWING_CONTINUE_COUNT, align 4
  %37 = icmp eq i32 %36, 0
...
nestedBlock5:                                     ; preds = %checkContinueBlock
  ...
  %42 = load i32, ptr @iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameiFlowWingAnim_FLOWWING_BREAK_COUNT, align 4
  %43 = icmp eq i32 %42, 0
  br i1 %43, label %checkContinueBlock6, label %afterNestedBlock

checkContinueBlock6:                              ; preds = %nestedBlock5
  %44 = load i32, ptr @iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameiFlowWingAnim_FLOWWING_CONTINUE_COUNT, align 4
  %45 = icmp eq i32 %44, 0
...
nestedBlock7:                                     ; preds = %checkContinueBlock6
  ...
  %54 = load i32, ptr @iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameiFlowWingAnim_FLOWWING_BREAK_COUNT, align 4
  %55 = icmp eq i32 %54, 0
  br i1 %55, label %checkContinueBlock8, label %afterNestedBlock

checkContinueBlock8:                              ; preds = %nestedBlock7
  %56 = load i32, ptr @iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameiFlowWingAnim_FLOWWING_CONTINUE_COUNT, align 4
  %57 = icmp eq i32 %56, 0
...
mergeBlock:                                       ; No predecessors!
  %31 = load i32, ptr @iUsersiappleicodeiperiFlow-Wingidocsidemoisnake-gameiFlowWingAnim_FLOWWING_BREAK_COUNT, align 4
  %32 = icmp eq i32 %31, 0
