; ModuleID = '-Users-apple-code-per-Flow-Wing-docs-demo-snake-game-flow-wing-raylib'
source_filename = "-Users-apple-code-per-Flow-Wing-docs-demo-snake-game-flow-wing-raylib"

%Texture.0 = type { i32, i32, i32, i32, i32 }

@-Users-apple-code-per-Flow-Wing-docs-demo-snake-game-flow-wing-raylib_FLOWWING_GLOBAL_TRUE = constant [5 x i8] c"true\00"
@-Users-apple-code-per-Flow-Wing-docs-demo-snake-game-flow-wing-raylib_FLOWWING_GLOBAL_FALSE = constant [6 x i8] c"false\00"
@-Users-apple-code-per-Flow-Wing-docs-demo-snake-game-flow-wing-raylib_FLOWWING_GLOBAL_NULL = external global i8
@-Users-apple-code-per-Flow-Wing-docs-demo-snake-game-flow-wing-raylib_FLOWWING_BREAK_COUNT = global i32 0
@-Users-apple-code-per-Flow-Wing-docs-demo-snake-game-flow-wing-raylib_FLOWWING_CONTINUE_COUNT = global i32 0
@-Users-apple-code-per-Flow-Wing-docs-demo-snake-game-flow-wing-raylib_FLOWWING_GLOBAL_ERROR_COUNT = global i32 0
...
define i32 @-Users-apple-code-per-Flow-Wing-docs-demo-snake-game-flow-wing-raylib() {
entry:
