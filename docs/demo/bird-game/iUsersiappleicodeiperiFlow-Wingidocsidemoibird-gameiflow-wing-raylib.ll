; ModuleID = 'iUsersiappleicodeiperiFlow-Wingidocsidemoibird-gameiflow-wing-raylib'
source_filename = "iUsersiappleicodeiperiFlow-Wingidocsidemoibird-gameiflow-wing-raylib"

%Texture.0 = type { i32, i32, i32, i32, i32 }

@iUsersiappleicodeiperiFlow-Wingidocsidemoibird-gameiflow-wing-raylib_FLOWWING_GLOBAL_TRUE = constant [5 x i8] c"true\00"
@iUsersiappleicodeiperiFlow-Wingidocsidemoibird-gameiflow-wing-raylib_FLOWWING_GLOBAL_FALSE = constant [6 x i8] c"false\00"
@iUsersiappleicodeiperiFlow-Wingidocsidemoibird-gameiflow-wing-raylib_FLOWWING_GLOBAL_NULL = external global i8
@iUsersiappleicodeiperiFlow-Wingidocsidemoibird-gameiflow-wing-raylib_FLOWWING_BREAK_COUNT = global i32 0
@iUsersiappleicodeiperiFlow-Wingidocsidemoibird-gameiflow-wing-raylib_FLOWWING_CONTINUE_COUNT = global i32 0
@iUsersiappleicodeiperiFlow-Wingidocsidemoibird-gameiflow-wing-raylib_FLOWWING_GLOBAL_ERROR_COUNT = global i32 0
...
define i32 @iUsersiappleicodeiperiFlow-Wingidocsidemoibird-gameiflow-wing-raylib() {
entry:
