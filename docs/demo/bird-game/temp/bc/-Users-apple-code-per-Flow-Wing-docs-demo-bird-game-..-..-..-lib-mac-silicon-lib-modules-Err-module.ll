; ModuleID = '-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module'
source_filename = "-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module"
...
@-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_GLOBAL_TRUE = constant [5 x i8] c"true\00"
@-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_GLOBAL_FALSE = constant [6 x i8] c"false\00"
@-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_GLOBAL_NULL = external global i8
@-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_BREAK_COUNT = global i32 0
@-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_CONTINUE_COUNT = global i32 0
@-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_GLOBAL_ERROR_COUNT = global i32 0
...
define i32 @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module(i32 %0, ptr %1) {
entry:
  ...
  store i32 2, ptr getelementptr inbounds (%"Err::ErrorCode.8", ptr @"Err::CODE", i32 0, i32 1), align 4
  store i32 3, ptr getelementptr inbounds (%"Err::ErrorCode.8", ptr @"Err::CODE", i32 0, i32 2), align 4
...
FillExpr.loopCmp-0:                               ; preds = %FillExpr.loopBody-0, %FillExpr.loopStart-0
  %2 = load i32, ptr @"_fg_i:0", align 4
  %3 = icmp slt i32 %2, 2
  %4 = load i32, ptr @"_fg_numberOfElementsFilled:", align 4
  %5 = icmp slt i32 %4, 2
  %6 = and i1 %3, %5
  br i1 %6, label %FillExpr.loopBody-0, label %FillExpr.loopEnd-0

FillExpr.loopBody-0:                              ; preds = %FillExpr.loopCmp-0
  %7 = load i32, ptr @"_fg_i:0", align 4
  %8 = getelementptr [2 x %"Err::ErrorCode.8"], ptr @"Err::x", i32 0, i32 %7
  store %"Err::ErrorCode.8" zeroinitializer, ptr %8, align 4
  %9 = load i32, ptr @"_fg_i:0", align 4
  %10 = add i32 %9, 1
  store i32 %10, ptr @"_fg_i:0", align 4
  %11 = load i32, ptr @"_fg_numberOfElementsFilled:", align 4
  %12 = add i32 %11, 1
  store i32 %12, ptr @"_fg_numberOfElementsFilled:", align 4
  br label %FillExpr.loopCmp-0
...
nestedBlock:                                      ; preds = %entry
  ...
  %10 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_BREAK_COUNT, align 4
  %11 = icmp eq i32 %10, 0
...
nestedBlock:                                      ; preds = %entry
  ...
  %12 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_BREAK_COUNT, align 4
  %13 = icmp eq i32 %12, 0
  br i1 %13, label %checkContinueBlock, label %afterNestedBlock

checkContinueBlock:                               ; preds = %nestedBlock
  %14 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_CONTINUE_COUNT, align 4
  %15 = icmp eq i32 %14, 0
...
nestedBlock1:                                     ; preds = %checkContinueBlock
  ...
  %19 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_BREAK_COUNT, align 4
  %20 = icmp eq i32 %19, 0
...
nestedBlock:                                      ; preds = %entry
  ...
  %14 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_BREAK_COUNT, align 4
  %15 = icmp eq i32 %14, 0
  br i1 %15, label %checkContinueBlock, label %afterNestedBlock

checkContinueBlock:                               ; preds = %nestedBlock
  %16 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_CONTINUE_COUNT, align 4
  %17 = icmp eq i32 %16, 0
...
nestedBlock1:                                     ; preds = %checkContinueBlock
  ...
  %21 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_BREAK_COUNT, align 4
  %22 = icmp eq i32 %21, 0
  br i1 %22, label %checkContinueBlock2, label %afterNestedBlock

checkContinueBlock2:                              ; preds = %nestedBlock1
  %23 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_CONTINUE_COUNT, align 4
  %24 = icmp eq i32 %23, 0
...
nestedBlock3:                                     ; preds = %checkContinueBlock2
  ...
  %28 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_BREAK_COUNT, align 4
  %29 = icmp eq i32 %28, 0
...
nestedBlock:                                      ; preds = %entry
  call void @"print_<Array[2]<Object<Err::ErrorCode.8>>:2,"(ptr @"Err::x")
  %6 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_BREAK_COUNT, align 4
  %7 = icmp eq i32 %6, 0
  br i1 %7, label %checkContinueBlock, label %afterNestedBlock

checkContinueBlock:                               ; preds = %nestedBlock
  %8 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_CONTINUE_COUNT, align 4
  %9 = icmp eq i32 %8, 0
...
mergeBlock:                                       ; No predecessors!
  %9 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_BREAK_COUNT, align 4
  %10 = icmp eq i32 %9, 0
...
mergeBlock:                                       ; No predecessors!
  %31 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_BREAK_COUNT, align 4
  %32 = icmp eq i32 %31, 0
...
mergeBlock:                                       ; No predecessors!
  %24 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_BREAK_COUNT, align 4
  %25 = icmp eq i32 %24, 0
...
checkContinueBlock:                               ; preds = %nestedBlock
  %12 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_CONTINUE_COUNT, align 4
  %13 = icmp eq i32 %12, 0
...
checkContinueBlock2:                              ; preds = %afterIfElse
  %18 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_CONTINUE_COUNT, align 4
  %19 = icmp eq i32 %18, 0
...
afterIfElse:                                      ; preds = %else, %afterNestedBlock5
  %20 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_BREAK_COUNT, align 4
  %21 = icmp eq i32 %20, 0
...
nestedBlock6:                                     ; preds = %then
  ...
  %33 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_BREAK_COUNT, align 4
  %34 = icmp eq i32 %33, 0
...
mergeBlock:                                       ; No predecessors!
  %36 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-demo-bird-game-..-..-..-lib-mac-silicon-lib-modules-Err-module_FLOWWING_BREAK_COUNT, align 4
  %37 = icmp eq i32 %36, 0
...
define internal void @"print_<Array[2]<Object<Err::ErrorCode.8>>:2,"(ptr %0) {
entry:
  %"0_i" = alloca i32, align 4
  %numberOfElementsFilled = alloca i32, align 4
  store i32 0, ptr %numberOfElementsFilled, align 4
...
con_print.loopBody:                               ; preds = %con_print.stage, %con_print.print.lobby
  ...
  %8 = getelementptr [2 x %"Err::ErrorCode.8"], ptr %0, i32 0, i32 %7
  call void @"print_Err::ErrorCode.8"(ptr %8)
...
define internal void @"print_Err::ErrorCode.8"(ptr %0) {
entry:
  ...
  %5 = getelementptr inbounds %"Err::ErrorCode.8", ptr %0, i32 0, i32 0
  ...
  call void (ptr, ...) @printf(ptr %11, ptr %12)
  %13 = getelementptr inbounds %"Err::ErrorCode.8", ptr %0, i32 0, i32 1
  ...
  %21 = getelementptr inbounds %"Err::ErrorCode.8", ptr %0, i32 0, i32 2
