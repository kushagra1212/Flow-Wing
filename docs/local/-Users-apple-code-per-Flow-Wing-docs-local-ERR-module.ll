...
nestedBlock:                                      ; preds = %entry
  ...
  %10 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-local-Err-module_FLOWWING_BREAK_COUNT, align 4
  %11 = icmp eq i32 %10, 0
...
nestedBlock:                                      ; preds = %entry
  ...
  %12 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-local-Err-module_FLOWWING_BREAK_COUNT, align 4
  %13 = icmp eq i32 %12, 0
  br i1 %13, label %checkContinueBlock, label %afterNestedBlock

checkContinueBlock:                               ; preds = %nestedBlock
  %14 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-local-Err-module_FLOWWING_CONTINUE_COUNT, align 4
  %15 = icmp eq i32 %14, 0
...
nestedBlock1:                                     ; preds = %checkContinueBlock
  ...
  %19 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-local-Err-module_FLOWWING_BREAK_COUNT, align 4
  %20 = icmp eq i32 %19, 0
...
nestedBlock:                                      ; preds = %entry
  ...
  %14 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-local-Err-module_FLOWWING_BREAK_COUNT, align 4
  %15 = icmp eq i32 %14, 0
  br i1 %15, label %checkContinueBlock, label %afterNestedBlock

checkContinueBlock:                               ; preds = %nestedBlock
  %16 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-local-Err-module_FLOWWING_CONTINUE_COUNT, align 4
  %17 = icmp eq i32 %16, 0
...
nestedBlock1:                                     ; preds = %checkContinueBlock
  ...
  %21 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-local-Err-module_FLOWWING_BREAK_COUNT, align 4
  %22 = icmp eq i32 %21, 0
  br i1 %22, label %checkContinueBlock2, label %afterNestedBlock

checkContinueBlock2:                              ; preds = %nestedBlock1
  %23 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-local-Err-module_FLOWWING_CONTINUE_COUNT, align 4
  %24 = icmp eq i32 %23, 0
...
nestedBlock3:                                     ; preds = %checkContinueBlock2
  ...
  %28 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-local-Err-module_FLOWWING_BREAK_COUNT, align 4
  %29 = icmp eq i32 %28, 0
...
mergeBlock:                                       ; No predecessors!
  %31 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-local-Err-module_FLOWWING_BREAK_COUNT, align 4
  %32 = icmp eq i32 %31, 0
...
mergeBlock:                                       ; No predecessors!
  %24 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-local-Err-module_FLOWWING_BREAK_COUNT, align 4
  %25 = icmp eq i32 %24, 0
...
checkContinueBlock:                               ; preds = %nestedBlock
  %12 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-local-Err-module_FLOWWING_CONTINUE_COUNT, align 4
  %13 = icmp eq i32 %12, 0
...
nestedBlock1:                                     ; preds = %checkContinueBlock
  ...
  %17 = call i32 @string_length(ptr %16)
  %18 = icmp eq i32 %17, 0
  %19 = select i1 %18, i1 false, i1 true
  br i1 %19, label %then, label %else

checkContinueBlock2:                              ; preds = %afterIfElse
  %20 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-local-Err-module_FLOWWING_CONTINUE_COUNT, align 4
  %21 = icmp eq i32 %20, 0
...
afterIfElse:                                      ; preds = %else, %afterNestedBlock5
  %22 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-local-Err-module_FLOWWING_BREAK_COUNT, align 4
  %23 = icmp eq i32 %22, 0
...
nestedBlock6:                                     ; preds = %then
  ...
  %25 = call ptr @concat_strings(ptr %24, ptr @11)
  %26 = load ptr, ptr %1, align 8
  %27 = getelementptr inbounds %"Err::Result", ptr %26, i32 0, i32 3
  %details10 = load ptr, ptr %27, align 8
  %28 = load ptr, ptr %27, align 8
  %29 = call ptr @concat_strings(ptr %25, ptr %28)
  %30 = call ptr @concat_strings(ptr %29, ptr @12)
  store ptr %30, ptr %result, align 8
  %31 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-local-Err-module_FLOWWING_BREAK_COUNT, align 4
  %32 = icmp eq i32 %31, 0
  br i1 %32, label %checkContinueBlock7, label %afterNestedBlock5
...
mergeBlock:                                       ; No predecessors!
  %34 = load i32, ptr @-Users-apple-code-per-Flow-Wing-docs-local-Err-module_FLOWWING_BREAK_COUNT, align 4
  %35 = icmp eq i32 %34, 0
  br i1 %35, label %checkContinueBlock4, label %afterNestedBlock
}
