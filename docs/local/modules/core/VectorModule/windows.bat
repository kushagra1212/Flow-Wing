...
set SHARED_LIB_PATH="flowwing_vector.dll"
set SHARED_LIB_PATH_O="flowwing_vector.o"
...
clang++ -std=c++20 -shared flowwing_vector.cpp -o %SHARED_LIB_PATH%
...
call %FLOW_WING_COMPILER_PATH% --F=%FLOW_WING_FILE% -O3 -L=%OTHER_LIB_PATH% -l=built_in_module -l=flowwing_vector  -l=flowwing_string
