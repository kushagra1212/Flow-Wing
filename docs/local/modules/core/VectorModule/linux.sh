...
export LD_LIBRARY_PATH=$OTHER_LIB_PATH:$LD_LIBRARY_PATH && $FLOW_WING_COMPILER_PATH --F=$FLOW_WING_FILE -O3 -L=$FLOW_WING_LIB_PATH -l=flowwing_vector -L=$OTHER_LIB_PATH -lbuilt_in_module -ldynamic
