...
declare !rt !9 void @"Err::main2"(ptr)

declare !rt !10 ptr @fopen(ptr, ptr)

declare !rt !11 i32 @fread(ptr, i32, i32, ptr)

declare !rt !12 i32 @fseek(ptr, i32, i32)

declare !rt !13 i32 @ftell(ptr)

declare !rt !14 ptr @calloc(i32, i32)

declare !rt !15 void @rewind(ptr)
...
declare !rt !16 void @"File::read.10"(ptr, ptr, ptr)
