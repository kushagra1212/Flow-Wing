; ModuleID = '-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module'
source_filename = "-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module"

%"Err::Result::VTableType" = type { ptr, ptr, ptr, ptr, ptr, ptr }
%"Err::ErrorCode.0" = type { i32, i32, i32 }
%"Err::Result" = type { ptr, ptr, i32, ptr }

@-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_GLOBAL_TRUE = constant [5 x i8] c"true\00"
@-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_GLOBAL_FALSE = constant [6 x i8] c"false\00"
@-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_GLOBAL_NULL = external global i8
@-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_BREAK_COUNT = global i32 0
@-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_CONTINUE_COUNT = global i32 0
@-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_GLOBAL_ERROR_COUNT = global i32 0
...
define i32 @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module() {
entry:
...
nestedBlock:                                      ; preds = %entry
  ...
  %10 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_BREAK_COUNT, align 4
  %11 = icmp eq i32 %10, 0
...
nestedBlock:                                      ; preds = %entry
  ...
  %12 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_BREAK_COUNT, align 4
  %13 = icmp eq i32 %12, 0
  br i1 %13, label %checkContinueBlock, label %afterNestedBlock

checkContinueBlock:                               ; preds = %nestedBlock
  %14 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_CONTINUE_COUNT, align 4
  %15 = icmp eq i32 %14, 0
...
nestedBlock1:                                     ; preds = %checkContinueBlock
  ...
  %19 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_BREAK_COUNT, align 4
  %20 = icmp eq i32 %19, 0
...
nestedBlock:                                      ; preds = %entry
  ...
  %14 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_BREAK_COUNT, align 4
  %15 = icmp eq i32 %14, 0
  br i1 %15, label %checkContinueBlock, label %afterNestedBlock

checkContinueBlock:                               ; preds = %nestedBlock
  %16 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_CONTINUE_COUNT, align 4
  %17 = icmp eq i32 %16, 0
...
nestedBlock1:                                     ; preds = %checkContinueBlock
  ...
  %21 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_BREAK_COUNT, align 4
  %22 = icmp eq i32 %21, 0
  br i1 %22, label %checkContinueBlock2, label %afterNestedBlock

checkContinueBlock2:                              ; preds = %nestedBlock1
  %23 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_CONTINUE_COUNT, align 4
  %24 = icmp eq i32 %23, 0
...
nestedBlock3:                                     ; preds = %checkContinueBlock2
  ...
  %28 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_BREAK_COUNT, align 4
  %29 = icmp eq i32 %28, 0
...
mergeBlock:                                       ; No predecessors!
  %9 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_BREAK_COUNT, align 4
  %10 = icmp eq i32 %9, 0
...
mergeBlock:                                       ; No predecessors!
  %31 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_BREAK_COUNT, align 4
  %32 = icmp eq i32 %31, 0
...
mergeBlock:                                       ; No predecessors!
  %24 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_BREAK_COUNT, align 4
  %25 = icmp eq i32 %24, 0
...
checkContinueBlock:                               ; preds = %nestedBlock
  %12 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_CONTINUE_COUNT, align 4
  %13 = icmp eq i32 %12, 0
...
checkContinueBlock2:                              ; preds = %afterIfElse
  %18 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_CONTINUE_COUNT, align 4
  %19 = icmp eq i32 %18, 0
...
afterIfElse:                                      ; preds = %else, %afterNestedBlock5
  %20 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_BREAK_COUNT, align 4
  %21 = icmp eq i32 %20, 0
...
nestedBlock6:                                     ; preds = %then
  ...
  %33 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_BREAK_COUNT, align 4
  %34 = icmp eq i32 %33, 0
...
mergeBlock:                                       ; No predecessors!
  %36 = load i32, ptr @-var-folders-1m-ql4hjc5s5_32h16pfp65y5780000gn-T-Users-apple-code-per-Flow-Wing-docs-local-modules-Error-Err-module_FLOWWING_BREAK_COUNT, align 4
  %37 = icmp eq i32 %36, 0
